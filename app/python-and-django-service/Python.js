      ...
      <div className=" relative overflow-hidden bg-[#442a79] xl:min-h-96 max-lg:h-auto">
        <div className="flex items-center max-sm:block max-lg:block  px-5 md:px-12 xl:px-28   max-sm:py-7 gap-10  pt-12 max-pt-1   max-xl:py-5">
          <div className="  ">
            ...
            <div className="text-[#dcd7f8]  mt-3 text-lg text-justify max-lg:base">
              <p>
          ...
          <Image
            ...
            width={400}
            height={400}
            alt="Python Django Flask Development"
...
"
      >
        ...
        <Image
          ...
          width={400}
          height={400}
          alt="Python Django Flask Animation"
          className="w-96 h-96 pt-0 max-sm:pt-1 max-lg:mx-auto"
        />
      </div>
        ...
        <div className="flex gap-10 mt-5">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-5">
            ...
            {rangeAndroid.map((item, index) => (
              <div key={index}>
                <div className="flex items-center gap-5">
                  <item.iconThree className={`text-4xl text-[${item.color}]`} />
              ...
              <div key={index}>
                <div className="flex flex-col lg:flex-row items-start gap-5">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="mt-2 text-justify">{item.descriptionFive}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-custome py-10 px-4 sm:px-4 md:px-10 lg:px-20 xl:px-28  grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="new-component relative md:col-span-6 w-full sm:w-full md:w-full lg:w-11/12 left-0 sm:left-0 md:left-1 lg:left-10 top-5">
          <form className="relative flex items-center bg-white border border-gray-300 rounded-full shadow-md overflow-hidden w-full max-w-xl focus-within:ring-2 focus-within:ring-indigo-500">
            <input
              type="email"
              placeholder="Email Your Address"
              name="emails"
              className="flex-1 h-16 px-6 text-base text-gray-700 placeholder-gray-500 bg-transparent focus:outline-none"
            />
            <button
              type="submit"
              name="submit"
              className="flex items-center gap-2 h-12 px-6 mr-2 text-base font-medium text-white bg-gradient-to-r from-[#ffbd84] to-[#ff1f8e] rounded-full shadow-md hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              style={{
